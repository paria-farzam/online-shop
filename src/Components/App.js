...
function App() {
  ...
  const [goodsState, goodsDispatch] = useReducer(GoodsReducer, {
    goods: [
      ...
      {name: 'دامن زنانه رنگارنگ', src: 'https://dkstatics-public.digikala.com/digikala-products/bf841376cca359cf8e868015b084125e62a53897_1614366017.jpg?x-oss-process=image/resize,m_lfit,h_600,w_600/quality,q_90', type: 'female', category : 'skirt', number : 3, color : 'gray', size : 'S', price : 154000, inventory : true, buy : 0, selected : false, goodsCounter : 0, date : new Date('2021-04-16'), key : 11},
